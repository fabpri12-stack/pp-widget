...
export const eventSchema = z.object({
  ...
  standardTicketLabel: z.string().nullable().optional(),
  standardTicketPriceDisplay: z.string().nullable().optional(),
  standardTicketDescription: z.string().nullable().optional(),

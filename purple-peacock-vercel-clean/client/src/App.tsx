...
type ModalMode = "menu" | "how" | "faq" | "video" | null;
    ...
    <div className="booking-step confirmation-screen" data-testid="section-confirmation">
      ...
      <div className="button-pair">
        ...
        {event.welcomeGuideUrl ? (
          <Button asChild className="book-button" data-testid="button-download-welcome" disabled={isFailed}>
            <a href={event.welcomeGuideUrl} target="_blank" rel="noreferrer">
              <Download size={16} /> Welcome guide
            </a>
          </Button>
        ) : (
          <Button className="book-button" data-testid="button-download-welcome" disabled>
            <Download size={16} /> Welcome guide
          </Button>
        )}
      </div>

...
function ConfirmationStep({
  ...
  return (
    <div className="booking-step confirmation-screen" data-testid="section-confirmation">
      ...
      <p className="eyebrow">{isEnquiry ? "Enquiry received" : "Returned from DesignMyNight"}</p>
      <h3>{isEnquiry ? "Enquiry received" : "Booking received"}, {bookingReturn?.firstName || customer.firstName || "guest"}</h3>
      <div className="booking-receipt">
        ...
        <p><strong>{isEnquiry ? "Status" : "Deposit paid"}</strong><span>{isEnquiry ? "Sales team follow-up" : formatMoney(depositTotal)}</span></p>
      </div>

    ...
    <section id="journey-panel" className="journey-panel liquid-panel" data-testid="section-booking-journey">
      ...
      <div className="journey-content">
        ...
        {event.secondaryTicketEnabled && (
          <div className="secondary-ticket-card" data-testid={`card-secondary-ticket-${event.id}`}>
            <div className="secondary-ticket-main">
              <span><Ticket size={16} /> {event.secondaryTicketLabel || "Alternative ticket option"}</span>
